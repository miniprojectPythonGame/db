...
CREATE TABLE AuctionedItems (
    auctioned_item_id int  NOT NULL,
...
ALTER TABLE AuctionedItems ADD CONSTRAINT AuctionedItems_Storage
...
ALTER TABLE BuyOrders ADD CONSTRAINT BuyOrders_Items
    FOREIGN KEY (item_id)
...
ALTER TABLE Heroes ADD CONSTRAINT Guild_Heroes
...
ALTER TABLE BuyOrders ADD CONSTRAINT Heroes_BuyOrders
...
ALTER TABLE Heroes ADD CONSTRAINT Heroes_CreatureStatistics
...
ALTER TABLE Heroes ADD CONSTRAINT Heroes_Players
...
ALTER TABLE Storage ADD CONSTRAINT Heroes_Storage
    FOREIGN KEY (hero_id)
    REFERENCES Heroes (hero_id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE Items ADD CONSTRAINT Items_ItemTypes
...
ALTER TABLE Items ADD CONSTRAINT Items_Statistics
    FOREIGN KEY (statistics_id)
    REFERENCES Statistics (statistics_id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE Heroes ADD CONSTRAINT Levels_Heroes
...
ALTER TABLE Statistics ADD CONSTRAINT Statistics_Bots
    FOREIGN KEY (statistics_id)
...
ALTER TABLE BuyNowItems ADD CONSTRAINT Storage_BuyNowItems
    FOREIGN KEY (storage_id)
    REFERENCES Storage (storage_id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE Storage ADD CONSTRAINT Storage_Items
    FOREIGN KEY (item_id)
    REFERENCES Items (item_id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE Maps ADD CONSTRAINT Trainer_Maps
    FOREIGN KEY (map_id)
